...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
            ...
            <div class="sidebar-brand-text mx-3">Приложение задачник</div>
        </a>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="#">
                ...
                <span id="addTask">Добавить задачу</span></a>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="#" id="inputUserSort">По пользователю</a>
                    <a class="collapse-item" href="#" id="inputEmailSort">По Email</a>
                    <a class="collapse-item" href="#" id="inputCompletedTasks">По выполненным<br>задачам</a>
                    <a class="collapse-item" href="#" id="inputTasksNotCompleted">По не выполненным<br>задачам</a>
                </div>
            </div>
        </li>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form
                    ...
                    <div class="input-group" id="formUserSort" style="display: none">
                        <input id="formUserSortCheck" name="formUserSortCheck" type="text" class="form-control"
                               placeholder="Поиск по пользователю"
                               aria-label="Search" aria-describedby="basic-addon2" required>
                        <div class="input-group-append">
                            <button id="sendUserSort" class="btn btn-primary" type="button">
                    ...
                    <div class="input-group" id="formEmailSort" style="display: none">
                        <input id="formEmailSortCheck" name="formUserEmailCheck" type="text" class="form-control"
                               placeholder="Поиск по Email"
                               aria-label="Search" aria-describedby="basic-addon2" required>
                        <div class="input-group-append">
                            <button id="sendEmailSorts" class="btn btn-primary" type="button">
                                <i class="fas fa-search fa-sm"></i>
                            </button>
                        </div>
                        <div class="invalid-feedback" id="formEmailSortErrorLogin">
                        </div>
                    </div>
                </form>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span id="adminStatus" class="mr-2 d-none d-lg-inline text-gray-600 small"></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="#" id="inputAdmin" style="display: none">
                                <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                Войти
                            </a>
                            <a class="dropdown-item" href="#" id="outputAdmin" style="display: none">
                                <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                Выйти
                            </a>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <form id="formAdmin" class="row justify-content-md-center" style="display: none">
                    ...
                    <div class="col-12 mt-3">
                        <button id="sendAdmin" class="btn btn-primary" type="button">Вход</button>
                    </div>
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-md-12">
